...
const About = () => {
    ...
    return (
        ...
        <h2>About us</h2>
        <div>
            <h3>What is Truth Checker?</h3>
            <p>Truth Checker is a federally managed registry for confirmed and certified Facts. All submitted Facts are reviewed and a select, few individuals determine what is True and what is False for United States citizens and mankind.</p>
        </div>
        <div>
            <h3>Our Mission</h3>
            <p>Making our (not your) country safer by stopping Fake News™ and Misinformation™ by conducting independent Truth investigations, advocating Truth improvements, and deciding Fact certification appeals.</p>
        </div>
        <div>
            ...
            <br/>
            <p>The Department of Truth and Facts (DTF) is an independent Federal agency charged by Congress with investigating every civil Truth accident in the United States and significant Fake News™ accidents in other modes of communication – television, radio, internet, and everything else. The DTF determines the probable cause of the Fake News™ accidents and issues Truth recommendations aimed at preventing future Fake News™. In addition, the DTF carries out special Truth Studies concerning Truth safety and coordinates the resources of the Federal Government and other organizations to provide assistance to Fake News™ victims and their family members impacted by major Fake News™ disasters.</p>
        </div>
        <div>
            <h3>Department of Truth and Facts Board</h3>
