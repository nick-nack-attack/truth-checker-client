      ...
      <div className='login-page-div'>
        ...
        <div>
          ...
          <p className="disclaimer-text">
            ...
            DISCLAIMER: ANY UNAUTHORIZED ACCESS TO THIS SYSTEM WILL RESULT IN VARIOUS TRIVIAL AND/OR ARBITRARY
            PUNISHMENTS IN ORDER TO PUBLICLY SHAME YOU AND/OR RUIN YOUR LIFE TO MAKE IT LOOK LIKE JUSTICE IS BEING
            SERVED AND/OR WE'RE KEEPING OUR (NOT YOUR) COMMUNITY SAFE.
          </p>
        </div>
      </div>
  );
