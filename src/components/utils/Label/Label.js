                                    ...
                                    : props.type === "addFact"
                                        ...
                                        : props.type === "view-facts"
                                            ...
                                            : props.type === "view-reports"
                                                ? <span className="black menu"><FontAwesomeIcon
                                                    icon={faExclamationCircle}/> View Reports </span>
                                                : props.type === "logout"
                                                    ?
                                                    <span className="black menu"><FontAwesomeIcon icon={faSignOutAlt}/> Log out </span>
                                                    : props.type === "login"
                                                        ? <span className="black menu"><FontAwesomeIcon
                                                            icon={faSignInAlt}/> Admin Login </span>
                                                        // info labels
                                                        : props.type === 'noResults'
                                                            ? <span className="fact-label black"><FontAwesomeIcon
                                                                icon={faEyeSlash}/> No Results Found </span>
                                                            : props.type === "admin"
                                                                ? <span><FontAwesomeIcon icon={faLock}/>{' '}Administrator Portal</span>
                                                                : props.type === "classified"
                                                                    ? <span
                                                                        className="classified-label"> CLASSIFIED </span>
                                                                    // action labels
                                                                    : props.type === "delete"
                                                                        ? <span className="fact-label"><FontAwesomeIcon
                                                                            icon={faTrash}/> Delete Fact </span>
                                                                        : props.type === "edit"
                                                                            ? <span
                                                                                className="fact-label"><FontAwesomeIcon
                                                                                icon={faEdit}/> Edit </span>
                                                                            : props.type === "report"
                                                                                ? <span
                                                                                    className="fact-label"><FontAwesomeIcon
                                                                                    icon={faFlag}/> Report </span>
                                                                                : ''
    );
};
